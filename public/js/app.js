...
var routes = [{
  path: '/',
  component: __webpack_require__.e(/*! import() */ "resources_js_views_Home_vue").then(__webpack_require__.t.bind(__webpack_require__, /*! ./views/Home.vue */ "./resources/js/views/Home.vue", 23))
}, {
  path: '/about',
